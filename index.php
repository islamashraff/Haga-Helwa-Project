...
<?php include 'modules/Products/Product.php' ?>
<?php
$productModel = new Product();
$featuredProducts = $productModel->getFeaturedProducts();
$singleProduct = $productModel->getProduct(1);
$newArrivals = $productModel->getNewArrival();
?>
<section id="hero">
...
<section id="product1" class="section-p1">
    ...
    <div class="pro-container">
        ...
        foreach ($featuredProducts as $product) { ?>
            <div class="pro">
                <img src="<?php echo $product['image'] ?>" alt="p1">
                <div class="des">
...
<section id="product1" class="section-p1">
    ...
    <div class="pro-container">
        ...
        foreach ($newArrivals as $newArrival) { ?>
            <div class="pro">
                <img src="<?php echo $newArrival['image'] ?>" alt="p1">
                <div class="des">
                    <span><? echo $newArrival['name'] ?></span>
                    <h5><?php echo $newArrival['Description'] ?></h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
